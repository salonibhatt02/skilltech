...
<head>
    ...
    <script>
        ...
        if (dropdown.style.display === "block" || dropdown.style.display === "") {
            dropdown.style.display = "none";
            card.style.zIndex = "0"; // Set z-index of card when dropdown is hidden
        } else {
            dropdown.style.display = "block";
            card.style.zIndex = "-1"; // Set z-index of card when dropdown is displayed
        }
        }
    </script>
</head>
<body>
    ...
    <?php
        ...
        //       <button type='submit' class='btn btn-primary'  data-bs-toggle='modal' data-bs-target='#exampleModal'>Buy now</button>
        //     </div>
        //   </div>";
